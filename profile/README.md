...
Тут представлена кодовая база для нашей платформы торговли криптовалютой, разработанной в рамках **VTB API Hackathon 2024**. Наше решение позволяет легко покупать и продавать криптовалюту, с поддержкой прямых переводов на карты ВТБ и обратно.
